...
<p>BIOF 439: Data Visualization using R
<p>Number of credits : 1
<p>Spring 2021 Term A
<p>Syllabus
</div>
...
Prerequisites, if any: None, though some knowledge and practice of R might be useful
...
especially the tidyverse packages, we will look at good principles for data
visualization, examples of good and bad visualizations, and the use of ggplot2
to create static publication-quality graphs. We will also explore modern
web-based interactive graphics using the htmlwidgets packages as well as dynamic
graphics and dashboards that can be created using flexdashboard and Shiny. We
will explore ways in which bioinformatics data can be presented using static and
dynamic visualizations. Finally, we will use RMarkdown and several packages to
develop web pages for presenting data visualizations as self-explanatory, and
possibly interactive, storyboards.
...
1. _Data Visualization: A Practical Introduction_ [DV] by Keiran Healy (available [online](https://socviz.co/){target="_blank"})
...
Office hours will be held on Zoom every Thursday 7:00-8:30 pm
...
2.	Final project: A presentation demonstrating visualizations in R using your own data  (20%)
3.	Class participation (30%): Discussion topics in weeks 2-6, as well as discussions on Slack

**Final project**

+	Create a R Markdown dashboard using the **flexdashboard** package
+	Use your own data, or data available on the web (legally)
+	Show me that you can create 3 visualizations using R, tied together to form a story. This must include
    - An exploratory/descriptive visualization
    - A visualization representing analytic results

+	5 minute lightning talks presenting your dashboard. These can be recorded using Quicktime or [Screencastify](https://www.screencastify.com){target=_blank}, which requires the Chrome browser
