...
+ Preferred method of communcation: via [Slack](https://biof439.slack.com){target=_blank}. Sign up link will be available the week before class starts
...
You will see a channel `#summer2021`. Please join this channel. Please use Slack for broadcasting messages, answering questions and the like. When you ask a question, please ask it under the `#general` or `#summer2021` channels, so others can learn as well. I should respond within 24 hours.
