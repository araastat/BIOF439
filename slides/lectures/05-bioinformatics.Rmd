...
knitr::opts_chunk$set(echo = TRUE, message=F, warning=F, comment = '#> ', cache=FALSE, fig.height=6)
library(tidyverse)
```
...
In BIOF339 we used UpSet plots to look at missing value patterns

```{r 05-bioinformatics-1, echo=F}
library(UpSetR)
library(ComplexHeatmap)
...
```{r 05-bioinformatics-2, echo =F, eval=F}
file_list = c(
