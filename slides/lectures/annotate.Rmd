...
.pull-right[
```{r annotate-1, eval=T, echo = F, ref.label="p1"}
```
]
...
.pull-right[
```{r annotate-2, eval=T, echo = F, ref.label="p2"}
```
]
...
.pull-right[
```{r annotate-3, eval=T, echo = F, ref.label="p3"}
```
]
...
.pull-right[
```{r annotate-4, eval=T, echo = F, ref.label="p4"}
```
]
...
.pull-right[
```{r annotate-5, eval=T, echo = F, ref.label="p5"}
```
]
---
class:middle,center
...
.pull-right[
```{r annotate-6, eval=T, echo=F, ref.label="b1"}
...
.pull-right[
```{r annotate-7, eval=T, echo=F, ref.label='b2'}
...
.pull-right[
```{r annotate-8,eval=T, echo=F, ref.label='c1'}
...
.pull-right[
```{r annotate-9, eval=T, echo=F, ref.label='c2'}
...
.pull-right[
```{r annotate-10, eval=T, echo=F, ref.label='d1'}
...
.pull-right[
```{r annotate-11, eval=T, echo=F, ref.label='d2'}
