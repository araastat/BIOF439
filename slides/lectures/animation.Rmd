...
knitr::opts_chunk$set(echo = FALSE, message=F, warning=F, comment = ' ', cache=FALSE,
...
.pull-right[
```{r animation-4, echo=TRUE, fig.height=4}
ggplotly(plt)
```
]
...
```{r animation-5, fig.height=5, fig.width=12, echo=TRUE}
...
```{r animation-6,echo=TRUE, fig.height=5}
...
.pull-right[
```{r animation-7, echo=F, eval=T, fig.height=4, ref.label='hc1'}
...
.pull-right[
```{r animation-8,ref.label='hc2', eval=T}
