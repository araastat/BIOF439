...
> These data are available in the class data folder/link, and the expectation is that you 
...
```{r joins-1, fig.caption = "`cbind`", echo=FALSE}
...
```{r joins-2, fig.caption="`rbind`", echo = FALSE}
