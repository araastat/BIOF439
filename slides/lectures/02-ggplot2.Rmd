...
knitr::opts_chunk$set(echo = TRUE, comment = '#> ', warning = FALSE, message=FALSE, cache=F, fig.height = 3.5)
library(tidyverse)
```
...
```{r 02-ggplot2-3, ref.label='gr2', eval=T, echo = F}
...
```{r 02-ggplot2-4, ref.label='gr3', eval=T, echo = F}
...
```{r 02-ggplot2-5, ref.label='gr4', eval=T, echo = F}
...
```{r 02-ggplot2-6, ref.label='gr5', eval=T, echo = F}
...
```{r 02-ggplot2-7, ref.label='gr6', eval=T, echo = F}
...
```{r 02-ggplot2-8, ref.label='gr7', eval=T, echo = F}
...
```{r 02-ggplot2-12, ref.label='gr8', eval=T, echo = F}
...
```{r 02-ggplot2-13, ref.label='gr9', eval=T, echo = F}
...
```{r 02-ggplot2-14, ref.label='gr10', eval=T, echo = F}
...
```{r 02-ggplot2-15, ref.label='gr11', eval=T, echo = F}
...
```{r 02-ggplot2-16, ref.label='gr12', eval=T, echo = F}
...
```{r 02-ggplot2-17, ref.label='gr13', eval=T, echo = F}
...
.pull-right[
```{r 02-ggplot2-20, eval=T, echo = F, ref.label="grp1"}
```
]
...
.pull-right[
```{r 02-ggplot2-21, eval=T, echo = F, ref.label="grp2"}
```
]
...
.pull-right[
```{r 02-ggplot2-22, eval=T, echo = F, ref.label="grp3"}
```
]
...
.pull-right[
```{r 02-ggplot2-23, eval=T, echo = F, ref.label="grp5"}
```
]
...
.pull-right[
```{r 02-ggplot2-24, eval=T, echo = F, ref.label="grp6"}
```
]
...
.pull-right[
```{r 02-ggplot2-25, eval=T, echo = F, ref.label="grp7"}
```
]
...
.pull-right[
```{r 02-ggplot2-26, eval=T, echo = F, ref.label="grp8"}
```
]
...
.pull-right[
```{r 02-ggplot2-27, eval=T, echo = F, ref.label="grp10"}
```
]
---
...
.pull-right[
```{r 02-ggplot2-28, ref.label='gr17', eval=T, echo=F}
...
.pull-right[
```{r 02-ggplot2-29, ref.label='gr20', echo = F, eval=T, message = T}
...
.pull-right[
```{r 02-ggplot2-30, ref.label='gr21', echo = F, eval=T, message = T}
...
.pull-right[
```{r 02-ggplot2-31, ref.label='gr22', echo = F, eval=T, message = T}
...
.pull-right[
```{r 02-ggplot2-32, ref.label='gr23', echo = F, eval=T, message = T}
...
.pull-right[
```{r 02-ggplot2-33, ref.label='gr24', eval=T, echo=F}
...
.pull-right[
```{r 02-ggplot2-34,ref.label='gr25', eval=T, echo = F}
...
.pull-right[
```{r 02-ggplot2-35,ref.label='gr26', eval=T, echo = F}
...
.pull-right[
```{r 02-ggplot2-36,ref.label='gr27', eval=T, echo = F}
...
.pull-left[
```{r 02-ggplot2-37, eval = T, warning = T, error = T}
...
.pull-right[
```{r 02-ggplot2-38, ref.label='gr_identity', eval = T, results='hide',echo = F}
...
.pull-right[
```{r 02-ggplot2-41, ref.label='gr28', eval=T, echo = F}
...
.pull-right[
```{r 02-ggplot2-42, ref.label='gr29', eval=T, echo = F}
...
.pull-right[
```{r 02-ggplot2-43, ref.label='gr30', eval=T, echo = F}
...
.pull-right[
```{r 02-ggplot2-44, ref.label='gr31', eval=T, echo = F}
...
.pull-right[
```{r 02-ggplot2-45, ref.label='gr32', eval=T, echo=F}
...
.pull-right[
```{r 02-ggplot2-46, ref.label='gr33', eval=T, echo=F}
...
.pull-right[
```{r 02-ggplot2-47,ref.label='gr34', echo = F, eval = T, message = F}
...
.pull-right[
```{r 02-ggplot2-48,ref.label='gr35', echo = F, eval = T, message = F}
...
.pull-right[
```{r 02-ggplot2-49,ref.label='gr36', echo = F, eval = T, message = F}
...
.pull-right[
```{r 02-ggplot2-50,ref.label='gr37', echo = F, eval = T, message = F}
...
.pull-right[
```{r 02-ggplot2-51,ref.label='gr38', echo = F, eval = T, message = F}
...
.pull-right[
```{r 02-ggplot2-52, ref.label='gr39', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-55, ref.label='gr40', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-56, ref.label='gr41', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-57, ref.label='gr42', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-58, ref.label='gr43', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-59, ref.label='gr44', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-60, ref.label='gr45', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-61, ref.label='gr53', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-62, ref.label='gr54', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-63, ref.label='gr55', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-64, ref.label='gr56', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-65, ref.label='gr561', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-66, ref.label='gr57', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-67, ref.label='gr58', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-68, ref.label='gr60', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-69, ref.label='gr61', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-70, ref.label='gr62', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-71, ref.label='gr63', eval = T, echo = F, message = F}
...
.pull-right[
```{r 02-ggplot2-72, ref.label='gr64', eval = T, echo = F, message = F}
...
.pull-right[
```{r 02-ggplot2-73, ref.label='gr65', eval = T, echo = F, message = F}
...
.pull-right[
```{r 02-ggplot2-74, ref.label='gr66', eval = T, echo = F, message = F}
...
.pull-right[
```{r 02-ggplot2-75, ref.label='gr68', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-76, ref.label='gr69', eval = T, echo = F}
...
.pull-right[
```{r 02-ggplot2-77, ref.label='gr70', echo = F, eval = T}
